...
# lottie_json = load_lottiefile("lottiefiles/sus.jpg")
...
with col2:
    st.image("lottiefiles/sus.jpg", width = 300)

with col3:
    st.write(' ')

st.markdown("<h1 style='text-align: center; color: #73b3c7;'>HOSPITAL INFORMATION MANAGEMENT SYSTEM (HIMS)</h1>", unsafe_allow_html=True)
...
# st_lottie(lottie_json, height=300, key="heart")
